...
/**
 * GoidTokenData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GoidTokenData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_goid_token_data';
     ...
     * Sets otp
     *
     * @param string|null $otp OTP from whatsapp or SMS
     *
     * @return self
     */
     ...
     * Sets otp_token
     *
     * @param string|null $otp_token OTP token from login request
     *
     * @return self
     */
